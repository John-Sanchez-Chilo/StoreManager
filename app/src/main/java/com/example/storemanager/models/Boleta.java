...
public class Boleta extends Item {
    private String name;
    private Fecha fecha;
    private ArrayList<Producto_Venta> lista_producto_venta;
    public Boleta(String name,Fecha fecha, ArrayList<Producto_Venta> lista_producto_venta ){
        this.name=name;
        this.fecha=fecha;
        this.lista_producto_venta=lista_producto_venta;
    }
    public Boleta(int id,String name,Fecha fecha, ArrayList<Producto_Venta> lista_producto_venta ){
        this.id=id;
        this.name=name;
        this.fecha=fecha;
        this.lista_producto_venta=lista_producto_venta;
    ...
    public Boleta(int id,String name,Fecha fecha, String string_codigos_productos,String string_cantidades ){
        this.name=name;
        this.fecha=fecha;
